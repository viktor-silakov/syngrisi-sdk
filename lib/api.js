    ...
    async createCheck(params, fileData, hashCode, apikey) {
        ...
        try {
            ...
            try {
                ...
                utils.printErrorResponseBody(e);
                throw new Error(`Cannot createCheck (post data) with url: '${url}', parameters: '${JSON.stringify(params)}', error: '${e}'`);
            }
        } catch (e) {
            throw new Error(`Cannot createCheck with parameters: '${JSON.stringify(params)}', error: '${e}'`);
        }
    }
}
